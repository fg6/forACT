...
if [[ $single == 1 ]]; then
	...
	#top
	alfile1=$dir/$aligner\_$shred/unique/foract$name_fornoise\_minid$minid.al
	afasta1=$dir/$aligner\_$shred/unique/foract$name_fornoise\_minid$minid.fasta

	#bottom
	alfile2=$comp_to/$aligner\_$shred/unique/foract$name_fornoise\_minid$minid.al
	afasta2=$comp_to/$aligner\_$shred/unique/foract$name_fornoise\_minid$minid.fasta
